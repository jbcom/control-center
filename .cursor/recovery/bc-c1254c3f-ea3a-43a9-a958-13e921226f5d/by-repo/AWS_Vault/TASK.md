...
```bash
# Check repo state
gh repo view AWS/Vault --json name,description
...
## Output
Create: `/workspace/.cursor/recovery/bc-c1254c3f-ea3a-43a9-a958-13e921226f5d/by-repo/AWS_Vault/RECOVERY_REPORT.md`
