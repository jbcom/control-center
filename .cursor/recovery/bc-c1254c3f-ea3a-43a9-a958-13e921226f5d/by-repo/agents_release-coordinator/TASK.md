# Repository Task: agents/release-coordinator
...
## Your Mission
1. Clone or access agents/release-coordinator
...
```bash
# Check repo state
gh repo view agents/release-coordinator --json name,description
...
## Output
Create: `/workspace/.cursor/recovery/bc-c1254c3f-ea3a-43a9-a958-13e921226f5d/by-repo/agents_release-coordinator/RECOVERY_REPORT.md`
