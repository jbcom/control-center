# Repository Task: actions/toolkit
...
## Your Mission
1. Clone or access actions/toolkit
...
```bash
# Check repo state
gh repo view actions/toolkit --json name,description
...
## Output
Create: `/workspace/.cursor/recovery/bc-c1254c3f-ea3a-43a9-a958-13e921226f5d/by-repo/actions_toolkit/RECOVERY_REPORT.md`
