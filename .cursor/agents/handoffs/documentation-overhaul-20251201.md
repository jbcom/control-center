...
- Cross-ecosystem (jbcom + ) workflows
...
1. **Unified Control Center** - Single repo now manages both ecosystems:
   ...
   - `ecosystems//` →  infrastructure (Terraform)
...
3. **FSC Absorption** - 1950 files merged from /fsc-control-center
...
- `ecosystems//` - Entire FSC infrastructure (NEW)
...
- [ ] `ecosystems//README.md` - Create overview
- [ ] `ecosystems//terraform/README.md` - Module index
- [ ] `ecosystems//sam/README.md` - Lambda docs (exists, verify)
- [ ] `ecosystems//config/README.md` - State path docs
