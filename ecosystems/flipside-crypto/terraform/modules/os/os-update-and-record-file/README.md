...
|------|-------------|------|---------|:--------:|
| <a name="input_allow_empty"></a> [allow\_empty](#input\_allow\_empty) | n/a | `bool` | `false` | no |
| <a name="input_allow_encoding"></a> [allow\_encoding](#input\_allow\_encoding) | n/a | `any` | `null` | no |
...
| <a name="input_file_data"></a> [file\_data](#input\_file\_data) | n/a | `any` | `null` | no |
| <a name="input_file_path"></a> [file\_path](#input\_file\_path) | n/a | `string` | n/a | yes |
| <a name="input_json_data"></a> [json\_data](#input\_json\_data) | n/a | `string` | `null` | no |
...
| <a name="input_yaml_data"></a> [yaml\_data](#input\_yaml\_data) | n/a | `string` | `null` | no |
