...
| <a name="input_preserve_names_as_is"></a> [preserve\_names\_as\_is](#input\_preserve\_names\_as\_is) | n/a | `any` | `[]` | no |
...
| <a name="output_gitkeep_records"></a> [gitkeep\_records](#output\_gitkeep\_records) | Data query results |
