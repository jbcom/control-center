...
|------|-------------|------|---------|:--------:|
| <a name="input_channels_only"></a> [channels\_only](#input\_channels\_only) | n/a | `bool` | `false` | no |
...
| <a name="input_exclude_archived"></a> [exclude\_archived](#input\_exclude\_archived) | n/a | `any` | `null` | no |
| <a name="input_get_members"></a> [get\_members](#input\_get\_members) | n/a | `bool` | `false` | no |
...
| <a name="input_types"></a> [types](#input\_types) | n/a | `any` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_conversations"></a> [conversations](#output\_conversations) | Data query results |
