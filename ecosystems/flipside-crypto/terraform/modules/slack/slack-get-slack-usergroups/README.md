...
|------|-------------|------|---------|:--------:|
| <a name="input_channel_identifiers_file"></a> [channel\_identifiers\_file](#input\_channel\_identifiers\_file) | n/a | `string` | `null` | no |
...
| <a name="input_expand_users"></a> [expand\_users](#input\_expand\_users) | n/a | `bool` | `false` | no |
| <a name="input_include_count"></a> [include\_count](#input\_include\_count) | n/a | `any` | `null` | no |
| <a name="input_include_disabled"></a> [include\_disabled](#input\_include\_disabled) | n/a | `any` | `null` | no |
| <a name="input_include_users"></a> [include\_users](#input\_include\_users) | n/a | `any` | `null` | no |
...
| <a name="input_prefix"></a> [prefix](#input\_prefix) | n/a | `bool` | `null` | no |
...
| <a name="input_user_identifiers_file"></a> [user\_identifiers\_file](#input\_user\_identifiers\_file) | n/a | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_user_groups"></a> [user\_groups](#output\_user\_groups) | Data query results |
