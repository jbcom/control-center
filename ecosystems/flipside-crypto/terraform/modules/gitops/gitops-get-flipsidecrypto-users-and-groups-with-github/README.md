...
| <a name="input_existing_github_users"></a> [existing\_github\_users](#input\_existing\_github\_users) | n/a | `any` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_users_with_github"></a> [users\_with\_github](#output\_users\_with\_github) | Data query results |
