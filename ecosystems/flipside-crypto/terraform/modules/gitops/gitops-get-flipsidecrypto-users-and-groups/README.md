...
| <a name="input_ensure_schemas"></a> [ensure\_schemas](#input\_ensure\_schemas) | n/a | `bool` | `true` | no |
| <a name="input_get_github"></a> [get\_github](#input\_get\_github) | n/a | `bool` | `false` | no |
| <a name="input_get_team_membership"></a> [get\_team\_membership](#input\_get\_team\_membership) | n/a | `bool` | `false` | no |
| <a name="input_get_zoom"></a> [get\_zoom](#input\_get\_zoom) | n/a | `bool` | `false` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_users_and_groups"></a> [users\_and\_groups](#output\_users\_and\_groups) | Data query results |
