...
|------|-------------|------|---------|:--------:|
| <a name="input_calendar_shares_by_email"></a> [calendar\_shares\_by\_email](#input\_calendar\_shares\_by\_email) | n/a | `any` | `null` | no |
...
| <a name="input_existing_google_groups"></a> [existing\_google\_groups](#input\_existing\_google\_groups) | n/a | `any` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_team_membership"></a> [team\_membership](#output\_team\_membership) | Data query results |
