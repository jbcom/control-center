...
| [env_sensitive.VAULT_ROLE_ID](https://registry.terraform.io/providers/tcarreira/env/latest/docs/data-sources/sensitive) | data source |
| [env_sensitive.VAULT_SECRET_ID](https://registry.terraform.io/providers/tcarreira/env/latest/docs/data-sources/sensitive) | data source |
| [env_sensitive.VAULT_TOKEN](https://registry.terraform.io/providers/tcarreira/env/latest/docs/data-sources/sensitive) | data source |
...
| [env_var.VAULT_APPROLE_PATH](https://registry.terraform.io/providers/tcarreira/env/latest/docs/data-sources/var) | data source |
| [env_var.VAULT_NAMESPACE](https://registry.terraform.io/providers/tcarreira/env/latest/docs/data-sources/var) | data source |
| [env_var.VAULT_URL](https://registry.terraform.io/providers/tcarreira/env/latest/docs/data-sources/var) | data source |
...
| <a name="input_max_depth"></a> [max\_depth](#input\_max\_depth) | n/a | `number` | `null` | no |
| <a name="input_mount_point"></a> [mount\_point](#input\_mount\_point) | n/a | `string` | `null` | no |
| <a name="input_params"></a> [params](#input\_params) | Override for multiple params | `any` | `{}` | no |
| <a name="input_root_path"></a> [root\_path](#input\_root\_path) | n/a | `string` | `"/"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_secrets"></a> [secrets](#output\_secrets) | Data query results |
