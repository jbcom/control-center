...
|------|-------------|------|---------|:--------:|
| <a name="input_allowed_ou_types"></a> [allowed\_ou\_types](#input\_allowed\_ou\_types) | n/a | `any` | `[]` | no |
...
| <a name="input_denied_ou_types"></a> [denied\_ou\_types](#input\_denied\_ou\_types) | n/a | `any` | `[]` | no |
| <a name="input_flatten_nested_org_units"></a> [flatten\_nested\_org\_units](#input\_flatten\_nested\_org\_units) | n/a | `bool` | `false` | no |
| <a name="input_include_root"></a> [include\_root](#input\_include\_root) | n/a | `bool` | `true` | no |
...
| <a name="input_unhump_org_units"></a> [unhump\_org\_units](#input\_unhump\_org\_units) | n/a | `bool` | `true` | no |
| <a name="input_use_basename"></a> [use\_basename](#input\_use\_basename) | n/a | `bool` | `false` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_org_units"></a> [org\_units](#output\_org\_units) | Data query results |
