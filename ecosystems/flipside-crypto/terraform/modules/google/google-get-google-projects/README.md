...
| <a name="input_key_results_by"></a> [key\_results\_by](#input\_key\_results\_by) | n/a | `string` | `"None"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_projects"></a> [projects](#output\_projects) | Data query results |
