...
|------|-------------|------|---------|:--------:|
| <a name="input_billing_dataset"></a> [billing\_dataset](#input\_billing\_dataset) | n/a | `string` | `null` | no |
| <a name="input_checksum"></a> [checksum](#input\_checksum) | Optional checksum to use for triggering resource updates | `string` | `""` | no |
| <a name="input_dataset_name"></a> [dataset\_name](#input\_dataset\_name) | n/a | `string` | `"billing_dataset"` | no |
...
| <a name="input_inactivity_period_days"></a> [inactivity\_period\_days](#input\_inactivity\_period\_days) | n/a | `integer` | `30` | no |
...
| <a name="input_project_id"></a> [project\_id](#input\_project\_id) | n/a | `string` | `"flipside-security-admin"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_dead_projects"></a> [dead\_projects](#output\_dead\_projects) | Data query results |
