...
| <a name="input_unhump_permission_sets"></a> [unhump\_permission\_sets](#input\_unhump\_permission\_sets) | n/a | `bool` | `false` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_permission_sets"></a> [permission\_sets](#output\_permission\_sets) | Data query results |
