...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_organization_units"></a> [aws\_organization\_units](#input\_aws\_organization\_units) | n/a | `any` | n/a | yes |
...
| <a name="input_default_environment"></a> [default\_environment](#input\_default\_environment) | n/a | `string` | `"global"` | no |
