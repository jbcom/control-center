...
| <a name="input_cluster_tags"></a> [cluster\_tags](#input\_cluster\_tags) | n/a | `any` | `{}` | no |
...
| <a name="input_dry_run"></a> [dry\_run](#input\_dry\_run) | n/a | `bool` | `false` | no |
...
| <a name="input_service_tags"></a> [service\_tags](#input\_service\_tags) | n/a | `any` | `{}` | no |
