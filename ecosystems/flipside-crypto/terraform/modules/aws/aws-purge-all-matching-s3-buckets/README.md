...
| <a name="input_name_tags"></a> [name\_tags](#input\_name\_tags) | n/a | `any` | `[]` | no |
| <a name="input_names"></a> [names](#input\_names) | n/a | `any` | `[]` | no |
| <a name="input_params"></a> [params](#input\_params) | Override for multiple params | `any` | `{}` | no |
| <a name="input_purge_file"></a> [purge\_file](#input\_purge\_file) | n/a | `string` | `null` | no |
