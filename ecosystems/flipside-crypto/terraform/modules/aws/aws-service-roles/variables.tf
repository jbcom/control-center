...
variable "service_linked_roles_denylist" {
  description = "Service linked roles not to create"
  type        = list(string)
  default     = []
}

variable "service_linked_roles_allowlist" {
  description = "Service linked roles to create. Leave empty to create all other than roles in the denylist."
  type        = list(string)
  default     = []
}

locals {
  service_linked_roles = coalescelist(var.service_linked_roles_allowlist, var.service_linked_roles)
}