...
SAML_PROVIDER_ARN="$(aws iam list-saml-providers --query "SAMLProviderList[?contains(Arn, 'AWSSSO')].Arn" --output json | jq -r '.[0]')"

echo '{"saml_provider_arn":"'"${SAML_PROVIDER_ARN}"'"}'