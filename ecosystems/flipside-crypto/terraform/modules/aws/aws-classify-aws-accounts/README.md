...
| <a name="input_suffix"></a> [suffix](#input\_suffix) | n/a | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_classifications"></a> [classifications](#output\_classifications) | Data query results |
