...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_organization"></a> [aws\_organization](#input\_aws\_organization) | n/a | `any` | n/a | yes |
...
| <a name="input_google_organization"></a> [google\_organization](#input\_google\_organization) | n/a | `any` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_organization"></a> [organization](#output\_organization) | Data query results |
