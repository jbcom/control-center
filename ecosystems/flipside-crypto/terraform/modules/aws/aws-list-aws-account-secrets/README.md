...
| <a name="input_get_secrets"></a> [get\_secrets](#input\_get\_secrets) | n/a | `bool` | `false` | no |
| <a name="input_log_file_name"></a> [log\_file\_name](#input\_log\_file\_name) | Port library parameter | `string` | `"run.log"` | no |
| <a name="input_no_empty_secrets"></a> [no\_empty\_secrets](#input\_no\_empty\_secrets) | n/a | `bool` | `false` | no |
