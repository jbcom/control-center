...
This repository's KMS key is: **arn:aws:kms:us-east-1:862006574860:alias/compass**.
...
```bash
sops -e -i --kms "arn:aws:kms:us-east-1:862006574860:alias/compass" your-secrets.json
```
