...
moved {
  from = aws_iam_user_login_profile.this
  to   = aws_iam_user_login_profile.this[0]
}
...
resource "aws_iam_user_policy_attachment" "this" {
  count = var.number_of_policies > 0 ? var.number_of_policies : 0
