...
case "$1" in
    ...
    spawn)
        ...
        if [ -z "$REPO" ] || [ -z "$TASK" ]; then
            ...
            echo "Example: fleet-manager.sh spawn https://github.com//terraform-modules 'Update dependencies' main"
            exit 1
        fi
...
3. The control manager can send you updates via addFollowup"
    ...
    help|*)
        ...
        echo "  fleet-manager.sh spawn https://github.com//terraform-modules 'Update deps' main"
