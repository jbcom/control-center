...
/workspace/scripts/fleet-manager.sh spawn \
    https://github.com//terraform-modules \
...
|---------------|--------------|------------|------------------|
| **FSC Control Center** |  | `/fsc-control-center` | Infrastructure pipeline orchestration |
...
FLIPSIDE_GITHUB_TOKEN    #  org access
...
**Requesting Repo**: /terraform-modules
...
This contribution addresses a need identified in  infrastructure.
