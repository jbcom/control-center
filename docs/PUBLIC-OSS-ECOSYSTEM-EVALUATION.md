...
├── AGENTS.md                       # Root instructions (generated by ruler)
├── .ruler/                         # Root ruler config
│   ├── AGENTS.md                   # Core ecosystem guidelines
...
├── packages/
│   ├── extended-data-types/
│   │   └── .ruler/                 # NESTED: EDT-specific
│   │       └── AGENTS.md           # Foundation lib rules
│   │
│   ├── agentic-control/
│   │   └── .ruler/                 # NESTED: TypeScript-specific
│   │       └── AGENTS.md           # CLI/fleet rules
│   │
│   └── vault-secret-sync/
│       └── .ruler/                 # NESTED: Go-specific
│           └── AGENTS.md           # Kubernetes operator rules

jbcom-control-center/               # PRIVATE CONTROL CENTER
├── .ruler/                         # Separate, focused rules
│   ├── AGENTS.md                   # Control center operations
│   ├── fsc-coordination.md         # FSC-specific
│   └── ruler.toml
│
└── ecosystems/
    └── flipside-crypto/            # Clean FSC structure
        ├── .ruler/                 # ONE nested ruler for FSC
        │   └── AGENTS.md           # FSC infrastructure rules
        ├── terraform/
        ├── sam/
        └── lib/
```
...
├── .ruler/                        # ONE clean ruler directory
│   ├── AGENTS.md                  # Control center operations only
│   ├── fsc-coordination.md        # FSC-specific operations
│   ├── ecosystem-management.md    # How to manage public + private
│   └── ruler.toml                 # nested = true for FSC
│
├── ecosystems/
│   ├── flipside-crypto/           # KEPT - private infrastructure
│   │   ├── .ruler/                # ONE nested ruler for ALL of FSC
│   │   │   └── AGENTS.md          # Infrastructure-focused rules
│   │   ├── terraform/             # NO MORE scattered .ruler here
│   │   ├── sam/                   # NO MORE scattered .ruler here
│   │   ├── lib/                   # NO MORE scattered .ruler here
│   │   └── memory-bank/
│   └── jbcom/                     # Reference to public ecosystem
│       └── README.md              # "See github.com/jbcom/jbcom-ecosystem"
│
├── memory-bank/
│   ├── activeContext.md
│   └── progress.md
├── agentic.config.json            # Manages both ecosystems
└── docs/
    └── ECOSYSTEM-MANAGEMENT.md
```
...
├── .ruler/                        # Root ruler config
│   ├── AGENTS.md                  # Welcome, contributing guide
│   ├── python-style.md            # Python package conventions
│   ├── typescript-style.md        # TypeScript conventions
│   ├── go-style.md                # Go conventions
...
│   ├── extended-data-types/
│   │   ├── .ruler/                # Nested: EDT-specific
│   │   │   └── AGENTS.md          # Foundation library rules
│   │   ├── src/
│   │   ├── tests/
│   │   └── pyproject.toml
│   │
│   ├── lifecyclelogging/
│   │   ├── .ruler/                # Nested: logging-specific
│   │   │   └── AGENTS.md
│   │   └── ...
│   │
│   ├── directed-inputs-class/
│   │   ├── .ruler/                # Nested: validation-specific
│   │   │   └── AGENTS.md
│   │   └── ...
│   │
│   ├── python-terraform-bridge/
│   │   ├── .ruler/                # Nested: terraform-specific
│   │   │   └── AGENTS.md
│   │   └── ...
│   │
│   ├── vendor-connectors/
│   │   ├── .ruler/                # Nested: cloud connectors
│   │   │   └── AGENTS.md
│   │   └── ...
│   │
│   ├── agentic-control/           # TypeScript
│   │   ├── .ruler/                # Nested: TypeScript CLI
│   │   │   └── AGENTS.md
│   │   └── ...
│   │
│   └── vault-secret-sync/         # Go
│       ├── .ruler/                # Nested: Go operator
│       │   └── AGENTS.md
│       └── ...
│
├── pyproject.toml                 # UV workspace
├── package.json                   # PNPM workspace
├── ECOSYSTEM.toml                 # Package manifest
└── memory-bank/                   # OSS contribution context
    └── contributing.md
```
