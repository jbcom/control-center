...
| core | [#129](https://github.com/strata-game-library/core/pull/129) | Open |
...
| core | [#128](https://github.com/strata-game-library/core/issues/128) | 🚨 CRITICAL: ESM not working |
...
| Repo | PR | Description |
|------|-----|-------------|
| otter-river-rush | [#63](https://github.com/arcade-cabinet/otter-river-rush/pull/63) | 🚨 SonarCloud failing |
...
2. strata-game-library/core#129
...
```
9. arcade-cabinet/otter-river-rush#63
...
- 🚨 `arcade-cabinet/otter-river-rush#63` - SonarCloud failing
- 🚨 `strata-game-library/core#128` - Critical ESM issue
